...
public class NavMeshAI_V9 : MonoBehaviour {
	...
	public bool isAngleSmall = false;
	//default = 80
	...
	public void setDestination()
	{
		...
		float distanceZ = System.Math.Abs(transform.position.z - target.z);
		
		if (distanceX < turnRadius && distanceZ < turnRadius) 
		{
			
			Debug.Log("WITHIN WAYPOINT LIMIT");
			startIdleTimer = true;
